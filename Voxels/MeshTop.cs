...
namespace Voxels
{
    ...
    [AddComponentMenu("Voxels/Mesh Top Creator"), RequireComponent(typeof(Rasterizer))]
    public class MeshTop : Processor
    {
        ...
        // Relative position of the sub containers to its origin
        public Vector3 containerOffset = Vector3.zero;
        // Relative scale of the sub containers
                ...
                if (width * height * depth * sides > 0)
                {
                    if (mainContainer == null)
                    {
                        ...
                        if (mainContainer != null)
                        {
                            ...
                            // Adapt final scaling by given property
                            scaling.x = scaling.x * containerScale.x;
                            scaling.y = scaling.y * containerScale.y;
                            scaling.z = scaling.z * containerScale.z;
                    ...
                    if (mainContainer != null && iterator != null)
                    {
                        ...
                        for (int number = 0; number < 10; ++number)
                        {
                            ...
                            // Find next voxel with no voxel above
                            do
                            {
                                group.material = iterator.GetNextMaterial(out color, out x, out y, out z);
                                group.transparency = color.a > 0 && color.a < 1;
                            }
                            while (voxels.GetMaterial(x, y + 1, z) != null && group.material != null);
                            ...
                            if (group.material != null)
                            {
                                ...
                                if (subContainer != null)
                                {
                                    ...
                                    subContainer.transform.localPosition = currentPosition + containerOffset;
            ...
            if (groups != null && groups.Count > 0)
            {
                ...
                if (mergeMeshes)
                {
                    ...
                    if (currentGroup != null)
                    {
                        ...
                        if (!opaqueOnly || (textureMaterialTemplate != null && voxelTexture != null) || (!currentGroup.Current.Key.transparency && (color.a <= 0 || color.a >= 1)))
                        {
